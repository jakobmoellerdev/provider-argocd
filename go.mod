...
replace github.com/argoproj/gitops-engine => github.com/jakobmoellerdev/gitops-engine v0.0.0-20231204145759-dc1d73ddd48c
...
require (
	...
	k8s.io/kubernetes v1.28.4 // indirect
